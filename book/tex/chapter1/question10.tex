\begin{quest}[Theorie \emph{PDA}]
  ...
  Leg uit ambiguiteit van de \emph{CFG}.\\
  Leidt ambiguiteit altijd tot een niet-deterministische \emph{PDA}? En vice-versa?
\end{quest}
...
Ambiguiteit wil zeggen dan de \emph{CFG} ambigu is, m.a.w. het is mogelijk een keuze te maken om na te gaan of een string wordt geaccepteerd of niet. Aangezien deze keuze ook moet reflecteren in de corresponderende \emph{PDA}, is de \emph{PDA} dus ook niet deterministisch.
